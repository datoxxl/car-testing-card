...
namespace TestCard.Domain
{
    ...
    public partial class v_TestingCard4Print
    {
        ...
        public Nullable<int> StepValue1 { get; set; }
        public Nullable<int> StepValue2 { get; set; }
        public Nullable<int> StepValue3 { get; set; }
        public Nullable<int> StepValue4 { get; set; }
        public string TestingStepName { get; set; }
        public string SubStepName1 { get; set; }
        public string SubStepName2 { get; set; }
        public string SubStepName3 { get; set; }
        public string SubStepName4 { get; set; }
    }
}
