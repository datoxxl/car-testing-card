...
namespace TestCard.Domain.Services
{
    public class PersonChangeRequestService : DomainServiceBase<PersonChangeRequest>
    {
        ...
        public PersonChangeRequestService(PersonInfo currentUser)
            : base(currentUser) { }

        public bool SaveChangeRequest(PersonChangeRequest request, PersonInfo currentPerson, ref bool? hasUnconfirmedRequest)
        {
        ...
        public override IQueryable<PersonChangeRequest> GetAll(DataFilterOption option, bool secureObject = false)
        {
